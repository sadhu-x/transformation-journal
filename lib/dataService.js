    ...
    try {
      ...
      try {
        ...
        if (apiNatalChart && apiNatalChart.planets && apiNatalChart.planets.length > 0) {
          ...
          console.log('Using API natal chart data:', natalChartData)
        } else {
          console.warn('API returned invalid data:', apiNatalChart)
        ...
        doshaAnalysis = doshas
        console.log('Using local natal chart data:', natalChartData)
      }
    } catch (error) {

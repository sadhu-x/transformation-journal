...
**Ascendant (Lagna)**: ${natalChartData.ascendant.rashi} ${natalChartData.ascendant.degree || 0}° - ${natalChartData.ascendant.nakshatra}

**Planetary Positions**:
${natalChartData.planets.map(p => `- ${p.planet}: ${p.rashi} ${p.degree || 0}° - ${p.nakshatra}`).join('\n')}
...
**Houses**:
${natalChartData.houses.map(h => `- House ${h.house}: ${h.rashi} ${h.degree || 0}°${h.lord ? ` (Lord: ${h.lord})` : ''}`).join('\n')}

...
import { calculateAccurateNatalChart, debugPlanetPosition } from './accurateNatalChart.js'
...
export const generateInstructionTemplate = (userConfig = {}) => {
  ...
  if (birthDate && birthDate !== '[Not provided]' && 
    ...
    try {
      ...
      const natalChart = calculateAccurateNatalChart(birthDate, birthTime, parseFloat(birthLatitude), parseFloat(birthLongitude))
  ...
  try {
    ...
    try {
      ...
      if (userProfile && userProfile.birth_date && userProfile.birth_time && 
        ...
        const natalChart = calculateAccurateNatalChart(

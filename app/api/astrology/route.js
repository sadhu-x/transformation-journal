...
export async function POST(request) {
  try {
    ...
    // Try Prokerala Western natal chart endpoint (GET method with query parameters)
    try {
      console.log('Calling Prokerala Western natal chart endpoint with GET')
      const url = `${PROKERALA_API_URL}/western/natal-chart?${params.toString()}`
